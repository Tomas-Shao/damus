...
public struct NdbStrIter: IteratorProtocol {
...
public struct NdbTagElem: Sequence, Hashable, Equatable {
    let note: NdbNote
    ...
    public static func == (lhs: NdbTagElem, rhs: NdbTagElem) -> Bool {
    ...
    public func makeIterator() -> NdbStrIter {
