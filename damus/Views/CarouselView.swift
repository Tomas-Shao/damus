...
let carousel_items = [
    CarouselItem(image: Image("digital-nomad", bundle: Bundle(for: DamusColors.self)), text: Text("Welcome to the social network \(Text("you", comment: "You, in this context, is the person who controls their own social network. You is used in the context of a larger sentence that welcomes the reader to the social network that they control themself.").italic()) control.", comment: "Welcoming message to the reader. The variable is 'you', the reader.")),
    ...
    CarouselItem(image: Image("undercover", bundle: Bundle(for: DamusColors.self)),
    ...
    CarouselItem(image: Image("bitcoin-p2p", bundle: Bundle(for: DamusColors.self)),
