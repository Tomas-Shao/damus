...
public func bech32_nopre_pubkey(_ pubkey: Pubkey) -> String {
    return bech32_encode(hrp: "", pubkey.bytes)
}

public func bech32_note_id(_ evid: NoteId) -> String {
...
public func privkey_to_pubkey_raw(sec: [UInt8]) -> Pubkey? {
...
public func save_pubkey(pubkey: Pubkey) {
...
public func save_privkey(privkey: Privkey) throws {
...
public func save_keypair(pubkey: Pubkey, privkey: Privkey) throws {
