...
public struct References<T: TagConvertible>: Sequence, IteratorProtocol {
...
public enum FollowRef: TagKeys, Hashable, TagConvertible, Equatable {
    ...
    public static func from_tag(tag: TagSequence) -> FollowRef? {
...
public enum RefId: TagConvertible, TagKeys, Equatable, Hashable {
    case event(NoteId)
    case pubkey(Pubkey)
    case quote(QuoteId)
    ...
    public static func from_tag(tag: TagSequence) -> RefId? {
        var i = tag.makeIterator()
