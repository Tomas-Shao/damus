...
public typealias NostrEvent = NdbNote
public typealias TagElem = NdbTagElem
public typealias Tag = TagSequence
public typealias Tags = TagsSequence
...
public func make_first_contact_event(keypair: Keypair) -> NostrEvent? {
    ...
    let liwei_pubkey = "52e9fb05982ff139905467ae2d93b9485bbbddfa28a327b19c3cd8dfd7761956" // lol
    let tags = [
        ["p", damus_pubkey],
        ["p", liwei_pubkey],
